...
Write-Host "   http://REDACTED_IP/ru/prompts" -ForegroundColor White
Write-Host "   http://REDACTED_IP/ru/category/legal" -ForegroundColor White
Write-Host "   http://REDACTED_IP/ru/category/image" -ForegroundColor White
