...
Write-Host "   - http://YOUR_SERVER_IP_HERE/ru/prompts - главная страница с категориями" -ForegroundColor White
Write-Host "   - http://YOUR_SERVER_IP_HERE/ru/category/legal - страница категории" -ForegroundColor White
Write-Host "   - http://YOUR_SERVER_IP_HERE/ru/category/image - категория с подкатегориями" -ForegroundColor White
