...
try {
    $response = Invoke-WebRequest -Uri "http://REDACTED_IP/ru/prompts" -UseBasicParsing
...
Write-Host "   - http://REDACTED_IP/ru/prompts - главная страница с категориями" -ForegroundColor White
Write-Host "   - http://REDACTED_IP/ru/category/legal - страница категории" -ForegroundColor White
Write-Host "   - http://REDACTED_IP/ru/category/image - категория с подкатегориями" -ForegroundColor White
