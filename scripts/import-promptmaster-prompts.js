...
// Читаем файл с промптами PromptMaster
const promptsFile = path.join(__dirname, '..', 'new_prompts_batch_promptmaster.json');
...
console.log(`Найдено ${transformedPrompts.length} промптов PromptMaster для импорта:`);
...
const outputFile = path.join(__dirname, '..', 'promptmaster_prompts_for_import.json');
