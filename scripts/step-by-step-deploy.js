...
const steps = [
  ...
  },
  {
    ...
    command: 'ssh root@REDACTED_IP "cd /root/prompthub && pm2 stop prompthub || true && pm2 delete prompthub || true && pm2 start ecosystem.config.js || pm2 start npm --name \'prompthub\' -- start"',
...
console.log('ssh root@REDACTED_IP "pm2 logs prompthub --lines 10"');
...
console.log('• Пароль для SSH: REDACTED_PASSWORD');
