...
async function fixRealRussianNames() {
  try {
    console.log('Fixing to REAL Russian names...')
    ...
    console.log('REAL Russian names fixed!')
  } catch (error) {
    console.error('Error:', error.message)
  }
}

fixRealRussianNames().finally(() => prisma.$disconnect())
