...
async function updateRealRussian() {
  try {
    console.log('Обновляем настоящие русские названия...')
    ...
    for (const cat of categories) {
      ...
      console.log('Обновлена:', cat.nameRu)
    }
    
    console.log('Русские названия обновлены!')
  } catch (error) {
    console.error('Ошибка:', error.message)
  }
}

updateRealRussian().finally(() => prisma.$disconnect())
