...
// Читаем файл с новыми промптами PromptMaster v3
const promptsFile = path.join(__dirname, '..', 'new_prompts_batch_promptmaster_v3.json');
...
console.log(`Найдено ${transformedPrompts.length} новых промптов PromptMaster v3 для импорта:`);
...
const outputFile = path.join(__dirname, '..', 'promptmaster_v3_prompts_for_import.json');
