...
// Читаем файл с промптами HitMaker
const promptsFile = path.join(__dirname, '..', 'new_prompts_batch_hitmaker.json');
...
console.log(`Найдено ${transformedPrompts.length} промптов HitMaker для импорта:`);
...
const outputFile = path.join(__dirname, '..', 'hitmaker_prompts_for_import.json');
