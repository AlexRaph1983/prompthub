...
async function testViewTrackingFixed() {
  try {
    console.log('🔍 Тестируем отслеживание просмотров с правильными заголовками...')
    ...
    // Тестируем API view-token с правильными заголовками
    ...
    try {
      ...
      if (tokenResponse.ok) {
        ...
        // Тестируем API track-view с правильными заголовками
