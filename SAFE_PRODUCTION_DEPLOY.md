...
curl -s http://YOUR_SERVER_IP_HERE:3000 | head -5
curl -s http://YOUR_SERVER_IP_HERE:3000/api/prompts?limit=3
```
...
2. **Сайт доступен**: http://YOUR_SERVER_IP_HERE:3000 отвечает HTML
